          ...
          >
            <DialogHeader className="pb-4">
              <DialogTitle className="text-xl text-center">
                <span className="text-gradient font-bold">Reward Redeemed!</span>
              </DialogTitle>
            ...
            <div className="space-y-4">
              <div className="bg-primary/5 p-4 rounded-lg border border-primary/10">
                <h4 className="text-sm font-medium mb-2">Share your achievement</h4>
                <SocialShareComponent 
                  title="Share your reward"
                  description={`I redeemed "${reward.title}" with ${reward.points} points on TaskQuest!`}
                  variant="default"
                />
              </div>
